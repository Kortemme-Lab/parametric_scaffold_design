...
class FragmentQualityAnalyzer:
    ...
    def run_sparksx(self, fasta_file, pssm_file):
        ...
        subprocess.check_call([os.path.join(self.sparksx_path_abs, 'bin', 'buildinp_query.sh'),
                               fasta_file])
...
if __name__ == '__main__':
    ...
    #site_settings = site_settings.load_site_settings()

    #fqa = FragmentQualityAnalyzer(site_settings['runpsipred_single'], site_settings['csblast'],
    ...
    #fdf = fqa.pick_fragments('data/fragment_quality_analysis/0/assembled.pdb', 'data/fragment_quality_analysis/0/assembled.fasta', 'data/fragment_quality_analysis/0')

    #fdf = 'data/fragment_quality_analysis/0/frags.fsc.200.9mers'
